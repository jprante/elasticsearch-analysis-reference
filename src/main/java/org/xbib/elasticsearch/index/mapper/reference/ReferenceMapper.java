...
public class ReferenceMapper extends FieldMapper {
    ...
    static final class Defaults {
        static final ReferenceFieldType FIELD_TYPE = new ReferenceFieldType();
    ...
    public static final class ReferenceFieldType extends MappedFieldType implements Cloneable {
        ...
        ReferenceFieldType(ReferenceMapper.ReferenceFieldType ref) {
            super(ref);
        }
    ...
    public static class Builder extends FieldMapper.Builder<Builder, ReferenceMapper> {
        ...
        Builder(String name, Client client) {
        ...
        Builder refIndex(String refIndex) {
            this.refIndex = refIndex;
            return this;
        }

        Builder refType(String refType) {
            this.refType = refType;
            return this;
        }

        @SuppressWarnings("unchecked")
        Builder refFields(Object refFields) {
